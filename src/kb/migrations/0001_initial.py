    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_timestamp', models.DateTimeField(auto_now=True, verbose_name='Updated timestamp')),
                ('slug', models.SlugField(editable=False)),
                ('video_assitor', models.URLField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prerequisites', models.ManyToManyField(blank=True, to='kb.TopicGrade')),
                ('topic_grade', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, related_name='Topic_grade', to='kb.topicgrade')),
            ],
            options={
                'abstract': False,
            },
