...
class Collectible(TimestampModel, RandomSlugModel, IsActiveModel, TranslatableModel):
    ...
    price = models.DecimalField(blank=True, null=True, decimal_places=2, max_digits=15)
...
class CollectiblePurchaseTransaction(Withdraw):
    ...
    def save(self, *args, **kwargs):
        ...
        collectible, new = StudentCollectible.objects.get_or_create(collectible=self, student=self.account.coinaccount.student)
