...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'templates'),os.path.join(BASE_DIR, 'custom/templates')],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
REPORT_EMAIL_RECEIVERS = ['armin@learnwithsocrates.com', "candy@learnwithsocrates.com", "brian@learnwithsocrates.com", "viridiana.rivera@learnwithsocrates.com"]
...
CRONJOBS = [
    ...
    ('0 1 * * *', 'app.cron.backup_database', '>> ' + os.path.join(BASE_DIR,'log/cron_dbbackup_job.log' + ' 2>&1 ')),
