...
def send_report_mail():
    ...
    userHistory = (User.objects
        ...
        .annotate(num_correct_questions=Count('student__studentblockquestionpresentationhistory__block_question_presentation__id', filter=(Q(student__studentblockquestionpresentationhistory__block_question_presentation__status=BlockQuestionPresentation.STATUS_CORRECT) & Q(student__studentblockquestionpresentationhistory__update_timestamp__gt=yesterday) & Q(student__studentblockquestionpresentationhistory__update_timestamp__lte=today))))
        .annotate(num_wrong_questions=Count('student__studentblockquestionpresentationhistory__block_question_presentation__id', filter=(Q(student__studentblockquestionpresentationhistory__block_question_presentation__status=BlockQuestionPresentation.STATUS_INCORRECT) & Q(student__studentblockquestionpresentationhistory__update_timestamp__gt=yesterday) & Q(student__studentblockquestionpresentationhistory__update_timestamp__lte=today))))
